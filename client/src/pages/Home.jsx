      ...
      <div className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-green-600 dark:text-green-500 font-semibold tracking-wide uppercase">Features</h2>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative group">
                ...
                <div className="relative px-7 py-6 bg-white dark:bg-gray-800 ring-1 ring-gray-900/5 dark:ring-gray-200/10 rounded-lg leading-none flex items-top justify-start space-x-6 hover:shadow-lg transition-all duration-200">
                  ...
                  <div className="space-y-2">
                    <p className="text-slate-800 dark:text-white text-lg font-medium">Inventory Management</p>
              ...
              <div className="relative group">
                ...
                <div className="relative px-7 py-6 bg-white dark:bg-gray-800 ring-1 ring-gray-900/5 dark:ring-gray-200/10 rounded-lg leading-none flex items-top justify-start space-x-6 hover:shadow-lg transition-all duration-200">
                  ...
                  <div className="space-y-2">
                    <p className="text-slate-800 dark:text-white text-lg font-medium">Shopping Lists</p>
