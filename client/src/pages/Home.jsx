      ...
      <div className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base font-semibold tracking-wide text-green-600 uppercase dark:text-green-500">Features</h2>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative group">
                ...
                <div className="relative flex justify-start py-6 space-x-6 leading-none transition-all duration-200 bg-white rounded-lg px-7 dark:bg-gray-800 ring-1 ring-gray-900/5 dark:ring-gray-200/10 items-top hover:shadow-lg">
                  ...
                  <div className="space-y-2">
                    <p className="text-lg font-medium text-slate-800 dark:text-white">Inventory Management</p>
                    <p className="text-slate-600 dark:text-slate-400">Keep track of all your household items in one place with easy categorization.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative flex justify-start py-6 space-x-6 leading-none transition-all duration-200 bg-white rounded-lg px-7 dark:bg-gray-800 ring-1 ring-gray-900/5 dark:ring-gray-200/10 items-top hover:shadow-lg">
                  ...
                  <div className="space-y-2">
                    <p className="text-lg font-medium text-slate-800 dark:text-white">Shopping Lists</p>
