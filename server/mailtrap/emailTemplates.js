...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
    <p>Thank you for signing up HomeStock! Your verification code is:</p>
    ...
    <p>Best regards,<br>HomeStock App Team</p>
  </div>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to HomeStock!</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #4CAF50, #45a049); padding: 20px; text-align: center;">
    <h1 style="color: white; margin: 0;">Welcome to HomeStock!</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>HomeStock is here to help you track your home inventory, groceries, and household essentials with ease.</p>

    <p>Here’s what you can do:</p>
    <ul>
      <li>📦 **Manage your inventory effortlessly**</li>
      <li>🔍 **Scan barcodes & QR codes for quick tracking**</li>
      <li>📊 **Get low-stock alerts & inventory insights**</li>
    </ul>

    <p>Start exploring your dashboard now:</p>
    <div style="text-align: center; margin: 30px 0;">
      <a href="{dashboardLink}" style="display: inline-block; background: #4CAF50; color: white; padding: 10px 20px; font-size: 16px; text-decoration: none; border-radius: 5px;">Go to Dashboard</a>
    </div>

    <p>If you have any questions, feel free to reach out. We're here to help!</p>

    <p>Happy organizing! 🎉</p>
    <p>Best regards,<br><strong>HomeStock App Team</strong></p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message, please do not reply to this email.</p>
  </div>
